...
export const getCoreWebVitalsOriginTool = {
    ...
    description: 'Get Core Web Vitals metrics (LCP, INP, CLS) for an entire origin/domain. Returns p75 values and distribution (good/needs improvement/poor percentages).',
    inputSchema: {
        type: 'object',
        properties: {
            origin: {
...
export const getCoreWebVitalsUrlTool = {
    ...
    description: 'Get Core Web Vitals metrics for a specific page URL. Returns p75 values and distribution for that page.',
    inputSchema: {
        type: 'object',
        properties: {
            url: {
...
export const getCwvHistoryOriginTool = {
    ...
    description: 'Get historical Core Web Vitals data for an origin over time. Shows trends in CWV metrics.',
    inputSchema: {
        type: 'object',
        properties: {
            origin: {
...
export const getCwvHistoryUrlTool = {
    ...
    description: 'Get historical Core Web Vitals data for a specific page over time. Shows trends in CWV metrics for that page.',
    inputSchema: {
        type: 'object',
        properties: {
            url: {
...
export const compareCwvFormFactorsTool = {
    ...
    description: 'Compare Core Web Vitals across different device types (desktop, mobile, tablet) for an origin or URL.',
    inputSchema: {
        type: 'object',
        properties: {
            origin: {
