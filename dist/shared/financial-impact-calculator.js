...
export class FinancialImpactCalculator {
    ...
    `;
        ...
        try {
            ...
            const daysAffected = Math.ceil((params.endDate.getTime() - params.startDate.getTime()) / msPerDay);
            ...
            logger.error('Failed to calculate financial impact', error);
            throw new Error(`Failed to calculate financial impact: ${error.message}`);
        }
    }
    /**
...
// Singleton instance
let financialImpactCalculatorInstance = null;
/**
 * Get financial impact calculator instance
 */
export function getFinancialImpactCalculator() {
...
//# sourceMappingURL=financial-impact-calculator.js.map