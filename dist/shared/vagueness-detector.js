...
export class VaguenessDetector {
        ...
        for (const pattern of VAGUE_PATTERNS.quantifiers) {
            if (pattern.test(text)) {
                ...
                if (match) {
                    ...
                    vaguenessScore += 15;
                    requiredClarifications.push(`Specify exactly which items you want to ${params.operation}`);
                }
            }
        }
     ...
     */
    checkMissingSpecifics(params, requiredClarifications, suggestions) {
        const inputParams = params.inputParams;
        // Budget operations should have exact amounts
        if (params.operation.includes('budget') ||
...
// Singleton instance
let vaguenessDetectorInstance = null;
/**
 * Get vagueness detector instance
 */
export function getVaguenessDetector() {
...
//# sourceMappingURL=vagueness-detector.js.map