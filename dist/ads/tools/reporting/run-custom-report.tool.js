...
export const runCustomReportTool = {
    ...
    async handler(input) {
        try {
            ...
            const { customerId, query, resource, metrics, dimensions, filters, dateRange, orderBy, limit } = validated;
...
Raw GAQL query is available for reuse or modification.`;
            ...
            logger.error('Failed to run custom report', error);
            throw error;
        }
    },
};
//# sourceMappingURL=run-custom-report.tool.js.map