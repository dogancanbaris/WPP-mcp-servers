 ...
 */
export function validateCruxQuery(input: unknown): z.infer<typeof CruxQuerySchema> {
 ...
 */
export function hasOrigin(input: unknown): input is { origin: string; formFactor?: string } {
 ...
 */
export function hasUrl(input: unknown): input is { url: string; formFactor?: string } {
