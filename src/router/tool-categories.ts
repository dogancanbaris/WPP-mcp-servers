 ...
 */
export function searchToolsByKeyword(query: string): string[] {
 ...
 */
export function getToolsByCategory(categoryKey: string): string[] {
 ...
 */
export function getToolsByPlatform(platform: string): string[] {
 ...
 */
export function getAllCategories(): Array<{ key: string; category: ToolCategory }> {
